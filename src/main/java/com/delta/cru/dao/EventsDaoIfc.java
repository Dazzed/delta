...
public interface EventsDaoIfc {
	...
	int insEventDetails(EventsVo eventDetails) throws DataAcesExcp;
	
	int insEventUserLocationNeeds(EventUserLocationNeedsVo eventUserLocationNeeds)  throws DataAcesExcp;
	
	String getSeq() throws DataAcesExcp;
